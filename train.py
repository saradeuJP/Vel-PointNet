...
parser.add_argument('--max_epoch', type=int, default=2500, help='Epoch to run [default: 250]')
...
def train():
    ...
    with tf.Graph().as_default():
        ...
        for epoch in range(MAX_EPOCH):
            ...
            knr = current_coord_pc.shape[0] / kfold # 18
            ...
            train_loss, train_accuracy = train_one_epoch(train_coord, train_vel, train_label, sess, ops, train_writer)
